...
objectClass: "Keter"
summary:
  "A (presumably) male human who secretes black goop that causes decay when
  touching anything. It is predatory and will drag a human into its pocket
  dimension."
author: "Dr Gears"
---

<Figure
  publicId="scp-106/106emergenceklay.jpg"
  alt="SCP-106, mid-emergence"
  width={400}
  height={300}
  align="right"
/>
...
<Figure
  publicId="scp-106/106door.png"
  alt="Corrosion damage on the initial recovery cell. Containment procedures have since been revised."
  width={1050}
  height={1400}
  align="right"
/>

**Description:** SCP-106 appears to be an elderly humanoid, with a general
appearance of advanced decomposition. This appearance may vary, but the
“rotting” quality is observed in all forms. SCP-106 is not exceptionally agile,
and will remain motionless for days at a time, waiting for prey. SCP-106 is also
capable of scaling any vertical surface and can remain suspended upside down
indefinitely. When attacking, SCP-106 will attempt to incapacitate prey by
damaging major organs, muscle groups, or tendons, then pull disabled prey into
its pocket dimension. SCP-106 appears to prefer human prey items in the 10-25
