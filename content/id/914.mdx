---
id: "914"
summary: 'A highly complicated machine with multiple "refinement" settings, outputting any object fed to it in a manner depending on said setting; Improves the inputted object'
